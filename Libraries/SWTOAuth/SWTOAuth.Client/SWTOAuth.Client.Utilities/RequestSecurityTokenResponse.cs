...
namespace SWTOAuth.Client.Utilities
{
    ...
    public class RequestSecurityTokenResponse
    {
        ...
        public static RequestSecurityTokenResponse FromJSON(string jsonRequestSecurityTokenService)
        {
            ...
            using (MemoryStream memoryStream = new MemoryStream(Encoding.UTF8.GetBytes(jsonRequestSecurityTokenService)))
            {
                ...
                returnToken.securityToken = WebUtility.HtmlDecode(returnToken.securityToken);
